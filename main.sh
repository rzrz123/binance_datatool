...
printf '\e[32m%s\e[0m | %s |\n' "$(date +%T)" "$(hline)"
python datalake.py generate kline-type um_futures "1m" --split-gaps --with-vwap --with-funding-rates
python datalake.py generate resample-type um_futures "1h" "0m"
# ================================================
# download cm data
# ================================================
# printf '\e[32m%s\e[0m | %s |\n' "$(date +%T)" "$(hline)"
